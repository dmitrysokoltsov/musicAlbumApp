...
class AlbumsViewController: UIViewController {
    ...
    private let tableView: UITableView = {
        ...
        tableView.backgroundColor = #colorLiteral(red: 1, green: 0.7429788709, blue: 1, alpha: 1)
    ...
    private func setupViews() {
        view.backgroundColor = #colorLiteral(red: 1, green: 0.7429788709, blue: 1, alpha: 1)
